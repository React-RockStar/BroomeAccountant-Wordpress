...
<body>
	...
	<div class="main">
		<div class="archive-mobile-section1 w-100">
			<div>
				<img src="<?php echo home_url();?>/assets/images/archive_img1.jpg" alt="" class="w-100">
			</div>
		</div>
		<div class="bg-white text-center archive-mobile-section1-content shadow-sm">
			<h1>Updates</h1>
			<p>
				It is a long established fact that a reader will be distracted by the readble content
				of a page when looking at its layout.
			</p>
			<button type="button" class="btn btn-outline-custom">Contact us</button>
		</div>
		<div class="archive-desktop-section1">
		...
		<div class="archive-section2 bg-white">
			<div class="archive-section2-category">
				<p class="archive-section2-category-date">12 May 2020</p>
				<div class="d-flex justify-content-between align-items-center">
					<div class="archive-section2-category-title">
						<h5 class="mb-0 hidden-text">A covid-19 update from us</h5>
						<h5 class="mb-0 hidden-text">at Broome Accountants</h5>
					</div>
					<div class="archive-section2-category-detail">
						<p class="mb-0 hidden-text">Due to covid-19, no personal appointments</p>
						<p class="mb-0 hidden-text">can be made. Our office operates as normal...</p>
					</div>
					<button type="button" class="btn archive-btn">Read more</button>	
				</div>
			</div>
			<div class="archive-section2-category mt-50">
				<p class="archive-section2-category-date">1 January 2020</p>
				<div class="d-flex justify-content-between align-items-center">
					<div class="archive-section2-category-title">
			...
			<div class="archive-section2-category mt-50 mb-500">
				<p class="archive-section2-category-date">05 June 2019</p>
				<div class="d-flex justify-content-between align-items-center">
					<div class="archive-section2-category-title">
